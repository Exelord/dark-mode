...
import AutoTimeSwitch from './auto-time-switch';
...
export default {
  ...
  get timeSwitch() {
    return atom.config.get('dark-mode.autoTimeSwitch');
  },

  get timeSwitchStart() {
    return atom.config.get('dark-mode.autoTimeSwitchStartTime');
  },

  get timeSwitchStop() {
    return atom.config.get('dark-mode.autoTimeSwitchStopTime');
  },
  ...
  activate() {
    ...
    this.autoTimeSwitch = new AutoTimeSwitch(this.timeSwitchStart, this.timeSwitchStop, this.onLight.bind(this), this.onDark.bind(this));
    this.autoTimeSwitch.active = this.timeSwitch;
  ...
  deactivate() {
    ...
    this.autoTimeSwitch.active = false;
  ...
  registerCallbacks() {
    ...
    this.subscriptions.add(atom.config.onDidChange('dark-mode.autoTeSwitch', ({newValue}) => {
      this.timeSwitch.active = newValue;
    }));
  },
